...

;;;;;;  "core/autoload/ui.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/ui.el

(autoload 'doom-resize-window "/Users/Richard/.emacs.d/core/autoload/ui" "\
...
(custom-autoload 'doom-big-font-mode "/Users/Richard/.emacs.d/core/autoload/ui" nil)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/scratch"
;;;;;;  "core/autoload/scratch.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/scratch.el

(autoload 'doom-scratch-buffer "/Users/Richard/.emacs.d/core/autoload/scratch" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/projects"
;;;;;;  "core/autoload/projects.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/projects.el

(autoload 'without-project-cache! "/Users/Richard/.emacs.d/core/autoload/projects" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/packages"
;;;;;;  "core/autoload/packages.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/packages.el

(autoload 'doom-refresh-packages-maybe "/Users/Richard/.emacs.d/core/autoload/packages" "\
...
(autoload 'doom-get-packages "~/.emacs.d/core/autoload/packages" "\
...
\(fn &key (INSTALLED \\='any) (PRIVATE \\='any) (DISABLED \\='any) (PINNED \\='any) (IGNORED \\='any) (SORT t) CHANGED BACKEND DEPS)" nil nil)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/message"
;;;;;;  "core/autoload/message.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/message.el

(autoload 'doom-ansi-apply "/Users/Richard/.emacs.d/core/autoload/message" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/hydras"
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/help"
;;;;;;  "core/autoload/help.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/help.el

(autoload 'doom-active-minor-modes "/Users/Richard/.emacs.d/core/autoload/help" "\
...
(autoload 'doom/describe-setters "~/.emacs.d/core/autoload/help" "\
...
(autoload 'doom/what-face "~/.emacs.d/core/autoload/help" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/files"
;;;;;;  "core/autoload/files.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/files.el

(autoload 'doom-files-in "/Users/Richard/.emacs.d/core/autoload/files" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/editor"
;;;;;;  "core/autoload/editor.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/editor.el

(autoload 'doom-surrounded-p "/Users/Richard/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/backward-to-bol-or-indent "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/forward-to-last-non-comment-or-eol "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/dumb-indent "~/.emacs.d/core/autoload/editor" "\
Inserts a tab character (or spaces x tab-width).

\(fn)" t nil)

(autoload 'doom/dumb-dedent "~/.emacs.d/core/autoload/editor" "\
Dedents the current line.

\(fn)" t nil)

(autoload 'doom/backward-kill-to-bol-and-indent "~/.emacs.d/core/autoload/editor" "\
Kill line to the first non-blank character. If invoked again
afterwards, kill line to beginning of line.

\(fn)" t nil)

(autoload 'doom/backward-delete-whitespace-to-column "~/.emacs.d/core/autoload/editor" "\
Delete back to the previous column of whitespace, or as much whitespace as
possible, or just one char if that's not possible.

\(fn)" t nil)

(autoload 'doom/delete-backward-char "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/retab "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/clone-and-narrow-buffer "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom/delete-trailing-newlines "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom*newline-indent-and-continue-comments "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom|enable-delete-trailing-whitespace "~/.emacs.d/core/autoload/editor" "\
...
(autoload 'doom|disable-delete-trailing-whitespace "~/.emacs.d/core/autoload/editor" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/debug"
;;;;;;  "core/autoload/debug.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/debug.el

(autoload 'doom-info "/Users/Richard/.emacs.d/core/autoload/debug" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/cli"
;;;;;;  "core/autoload/cli.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/cli.el

(autoload 'doom//update "/Users/Richard/.emacs.d/core/autoload/cli" "\
TODO
...
(autoload 'doom/reload "~/.emacs.d/core/autoload/cli" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/cache"
;;;;;;  "core/autoload/cache.el" (0 0 0 0))
;;; Generated autoloads from core/autoload/cache.el

(autoload 'with-cache! "/Users/Richard/.emacs.d/core/autoload/cache" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/core/autoload/buffers"
...
(defvar doom-cleanup-hook nil "\
A list of hooks run when `doom/cleanup-session' is run, meant to clean up
leftover buffers and processes.")

(autoload 'doom-buffer-frame-predicate "/Users/Richard/.emacs.d/core/autoload/buffers" "\
...
(autoload 'doom/cleanup-session "~/.emacs.d/core/autoload/buffers" "\
Clean up buried buries and orphaned processes in the current workspace. If
ALL-P (universal argument), clean them up globally.

\(fn &optional BUFFER-LIST)" t nil)

(autoload 'doom/cleanup-buffer-processes "~/.emacs.d/core/autoload/buffers" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/completion/company/autoload"
...
(def-setting! :company-backend (modes &rest backends) :obsolete set-company-backend! `(set-company-backend! ,modes ,@backends))

(autoload '+company|init-backends "/Users/Richard/.emacs.d/modules/completion/company/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/completion/helm/autoload/posframe"
...
(autoload '+helm-poshandler-frame-center-near-bottom "/Users/Richard/.emacs.d/modules/completion/helm/autoload/posframe" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/completion/helm/autoload/helm"
;;;;;;  "modules/completion/helm/autoload/helm.el" (0 0 0 0))
;;; Generated autoloads from modules/completion/helm/autoload/helm.el

(autoload '+helm/tasks "/Users/Richard/.emacs.d/modules/completion/helm/autoload/helm" "\
...
\(fn &optional ALL-FILES-P)" t nil)
 (autoload '+helm/rg "/Users/Richard/.emacs.d/modules/completion/helm/autoload/helm")
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/completion/helm/autoload/evil"
;;;;;;  "modules/completion/helm/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/completion/helm/autoload/evil.el
 (autoload '+helm:swoop "/Users/Richard/.emacs.d/modules/completion/helm/autoload/evil" nil t)
 (autoload '+helm:pt "~/.emacs.d/modules/completion/helm/autoload/evil" nil t)
...
(autoload '+helm--set-prompt-display "/Users/Richard/.emacs.d/modules/completion/helm/autoload/evil" "\
TODO
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/config/default/autoload/evil"
;;;;;;  "modules/config/default/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/config/default/autoload/evil.el
 (autoload '+default:multi-next-line "/Users/Richard/.emacs.d/modules/config/default/autoload/evil" nil t)
 (autoload '+default:multi-previous-line "~/.emacs.d/modules/config/default/autoload/evil" nil t)
 (autoload '+default:cd "~/.emacs.d/modules/config/default/autoload/evil" nil t)
 (autoload '+default:kill-all-buffers "~/.emacs.d/modules/config/default/autoload/evil" nil t)
 (autoload '+default:kill-matching-buffers "~/.emacs.d/modules/config/default/autoload/evil" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/config/default/autoload/default"
;;;;;;  "modules/config/default/autoload/default.el" (0 0 0 0))
;;; Generated autoloads from modules/config/default/autoload/default.el

(autoload '+default/yank-buffer-filename "/Users/Richard/.emacs.d/modules/config/default/autoload/default" "\
...
(autoload '+default/browse-snippets "~/.emacs.d/modules/config/default/autoload/default" "\


\(fn)" t nil)

(autoload '+default/find-in-snippets "~/.emacs.d/modules/config/default/autoload/default" "\


\(fn)" t nil)

(autoload '+default/find-in-config "~/.emacs.d/modules/config/default/autoload/default" "\
Open a file somewhere in `doom-private-dir' via a fuzzy filename search.

\(fn)" t nil)

(autoload '+default/browse-config "~/.emacs.d/modules/config/default/autoload/default" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/editor/rotate-text/autoload"
...
(def-setting! :rotate (modes &rest plist) :obsolete set-rotate-patterns! `(set-rotate-patterns! ,modes ,@plist))

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/electric/autoload"
;;;;;;  "modules/emacs/electric/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/electric/autoload.el

(def-setting! :electric (modes &rest plist) :obsolete set-electric! `(set-electric! ,modes ,@plist))

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/prompts"
;;;;;;  "modules/emacs/eshell/autoload/prompts.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/eshell/autoload/prompts.el

(defface +eshell-prompt-pwd '((t :inherit font-lock-constant-face)) "\
TODO" :group (quote eshell))

(defface +eshell-prompt-git-branch '((t :inherit font-lock-builtin-face)) "\
TODO" :group (quote eshell))

(autoload '+eshell-default-prompt "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/prompts" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/evil"
;;;;;;  "modules/emacs/eshell/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/eshell/autoload/evil.el

(autoload '+eshell|init-evil "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/evil" "\
...
\(fn)" nil nil)
 (autoload '+eshell:run "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/evil" nil t)

(autoload '+eshell|goto-prompt-on-insert "~/.emacs.d/modules/emacs/eshell/autoload/evil" "\
Move cursor to the prompt when switching to insert mode (if point isn't
already there).

\(fn)" nil nil)

(autoload '+eshell/goto-end-of-prompt "~/.emacs.d/modules/emacs/eshell/autoload/evil" "\
Move cursor to the prompt when switching to insert mode (if point isn't
already there).

\(fn)" t nil)
 (autoload '+eshell/evil-change "~/.emacs.d/modules/emacs/eshell/autoload/evil" nil t)
 (autoload '+eshell/evil-change-line "~/.emacs.d/modules/emacs/eshell/autoload/evil" nil t)
 (autoload '+eshell/evil-delete "~/.emacs.d/modules/emacs/eshell/autoload/evil" nil t)
 (autoload '+eshell/evil-delete-line "~/.emacs.d/modules/emacs/eshell/autoload/evil" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/eshell"
;;;;;;  "modules/emacs/eshell/autoload/eshell.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/eshell/autoload/eshell.el

(autoload '+eshell-last-buffer "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Return the last opened eshell buffer.

\(fn &optional NOERROR)" nil nil)

(autoload '+eshell-buffers "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
TODO

\(fn)" nil nil)

(autoload '+eshell-run-command "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
TODO

\(fn COMMAND &optional BUFFER)" nil nil)

(autoload '+eshell/open "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Open eshell in the current buffer.

\(fn ARG &optional COMMAND)" t nil)

(autoload '+eshell/open-popup "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Open eshell in a popup window.

\(fn ARG &optional COMMAND)" t nil)

(autoload '+eshell/open-fullscreen "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Open eshell in a separate workspace. Requires the (:feature workspaces)
module to be loaded.

\(fn ARG &optional COMMAND)" t nil)

(autoload '+eshell/search-history "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Search the eshell command history with helm, ivy or `eshell-list-history'.

\(fn)" t nil)

(autoload '+eshell/pcomplete "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
...
(autoload '+eshell/quit-or-delete-char "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Delete a character (ahead of the cursor) or quit eshell if there's nothing to
delete.

\(fn ARG)" t nil)

(autoload '+eshell/split-below "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Create a new eshell window below the current one.

\(fn)" t nil)

(autoload '+eshell/split-right "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Create a new eshell window to the right of the current one.

\(fn)" t nil)

(autoload '+eshell/switch-to-next "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Switch to the next eshell buffer.

\(fn)" t nil)

(autoload '+eshell/switch-to-previous "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Switch to the previous eshell buffer.

\(fn)" t nil)

(autoload '+eshell/switch-to-last "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Switch to the last eshell buffer that was open (and is still alive).

\(fn)" t nil)

(autoload '+eshell/switch-to "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Interactively switch to another eshell buffer.

\(fn BUFFER)" t nil)

(autoload '+eshell/kill-and-close "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Kill the current eshell buffer and close its window.

\(fn)" t nil)

(autoload '+eshell|init "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Initialize and track this eshell buffer in `+eshell-buffers'.

\(fn)" nil nil)

(autoload '+eshell|cleanup "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\
Close window (or workspace) on quit.

\(fn)" nil nil)

(autoload '+eshell|switch-workspace "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\


\(fn TYPE)" nil nil)

(autoload '+eshell|save-workspace "~/.emacs.d/modules/emacs/eshell/autoload/eshell" "\


\(fn WORKSPACE TARGET)" nil nil)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/commands"
;;;;;;  "modules/emacs/eshell/autoload/commands.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/eshell/autoload/commands.el

(autoload 'eshell/cd-to-project "/Users/Richard/.emacs.d/modules/emacs/eshell/autoload/commands" "\
Change to the project root of the current directory.

\(fn)" nil nil)

(autoload 'eshell/quit-and-close "~/.emacs.d/modules/emacs/eshell/autoload/commands" "\
Quit the current eshell buffer and close the window it's in.

\(fn &rest _)" nil nil)

(autoload 'eshell/mkdir-and-cd "~/.emacs.d/modules/emacs/eshell/autoload/commands" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/hideshow/autoload"
;;;;;;  "modules/emacs/hideshow/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/hideshow/autoload.el

(autoload '+hideshow*ensure-mode "/Users/Richard/.emacs.d/modules/emacs/hideshow/autoload" "\
Ensure hs-minor-mode is enabled.

\(fn &rest _)" nil nil)

(autoload '+hideshow-haml-forward-sexp "~/.emacs.d/modules/emacs/hideshow/autoload" "\


\(fn ARG)" nil nil)

(autoload '+hideshow-forward-block-by-indent "~/.emacs.d/modules/emacs/hideshow/autoload" "\


\(fn ARG)" nil nil)

(autoload '+hideshow-set-up-overlay "~/.emacs.d/modules/emacs/hideshow/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/vc/autoload/vc"
;;;;;;  "modules/emacs/vc/autoload/vc.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/vc/autoload/vc.el

(autoload '+vc-git-root-url "/Users/Richard/.emacs.d/modules/emacs/vc/autoload/vc" "\
Return the root git repo URL for the current file.

\(fn)" nil nil)

(autoload '+vc/git-browse "~/.emacs.d/modules/emacs/vc/autoload/vc" "\
Open the website for the current version controlled file. Fallback to
repository root.

\(fn ARG)" t nil)

(autoload '+vc/git-browse-issues "~/.emacs.d/modules/emacs/vc/autoload/vc" "\
Open the issues page for current repo.

\(fn ARG)" t nil)

(autoload '+vc/git-browse-pulls "~/.emacs.d/modules/emacs/vc/autoload/vc" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/emacs/vc/autoload/evil"
;;;;;;  "modules/emacs/vc/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/emacs/vc/autoload/evil.el
 (autoload '+vc:git-browse "/Users/Richard/.emacs.d/modules/emacs/vc/autoload/evil" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/eval/autoload/settings"
...
(def-setting! :repl (mode command) :obsolete set-repl-handler! `(set-repl-handler! ,mode ,command))

(defvar +eval-runners nil "\
Alist mapping major modes to interactive runner functions.")

(def-setting! :eval (mode command) :obsolete set-eval-handler! `(set-eval-handler! ,mode ,command))

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/eval/autoload/repl"
;;;;;;  "modules/feature/eval/autoload/repl.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/eval/autoload/repl.el

(autoload '+eval/open-repl "/Users/Richard/.emacs.d/modules/feature/eval/autoload/repl" "\
...
\(fn &optional SAME-WINDOW-P)" t nil)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/eval/autoload/evil"
;;;;;;  "modules/feature/eval/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/eval/autoload/evil.el
 (autoload '+eval:region "/Users/Richard/.emacs.d/modules/feature/eval/autoload/evil" nil t)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/eval/autoload/eval"
;;;;;;  "modules/feature/eval/autoload/eval.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/eval/autoload/eval.el

(autoload '+eval/buffer "/Users/Richard/.emacs.d/modules/feature/eval/autoload/eval" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/evil/autoload/folds"
;;;;;;  "modules/feature/evil/autoload/folds.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/evil/autoload/folds.el

(autoload '+evil/fold-toggle "/Users/Richard/.emacs.d/modules/feature/evil/autoload/folds" "\
...
(autoload '+evil/fold-open "~/.emacs.d/modules/feature/evil/autoload/folds" "\
...
(autoload '+evil/fold-close "~/.emacs.d/modules/feature/evil/autoload/folds" "\
...
(autoload '+evil/fold-open-all "~/.emacs.d/modules/feature/evil/autoload/folds" "\
Open folds at LEVEL (or all folds if LEVEL is nil).

\(fn &optional LEVEL)" t nil)

(autoload '+evil/fold-close-all "~/.emacs.d/modules/feature/evil/autoload/folds" "\
Close folds at LEVEL (or all folds if LEVEL is nil).

\(fn &optional LEVEL)" t nil)

(autoload '+evil/fold-next "~/.emacs.d/modules/feature/evil/autoload/folds" "\
Jump to the next vimish fold, outline heading or folded region.

\(fn COUNT)" t nil)

(autoload '+evil/fold-previous "~/.emacs.d/modules/feature/evil/autoload/folds" "\
Jump to the previous vimish fold, outline heading or folded region.

\(fn COUNT)" t nil)

(autoload '+evil/matchit-or-toggle-fold "~/.emacs.d/modules/feature/evil/autoload/folds" "\
Do what I mean.
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/evil/autoload/files"
;;;;;;  "modules/feature/evil/autoload/files.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/evil/autoload/files.el
 (autoload '+evil:delete-this-file "/Users/Richard/.emacs.d/modules/feature/evil/autoload/files" nil t)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil"
;;;;;;  "modules/feature/evil/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/evil/autoload/evil.el

(def-setting! :evil-state (modes state) :obsolete set-evil-initial-state! `(set-evil-initial-state! ,modes ,state))

(autoload '+evil/visual-indent "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil" "\
vnoremap < <gv
...
\(fn)" t nil)
 (autoload '+evil:apply-macro "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil" nil t)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil-mc"
;;;;;;  "modules/feature/evil/autoload/evil-mc.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/evil/autoload/evil-mc.el

(autoload '+evil/mc-toggle-cursors "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil-mc" "\
Toggle frozen state of evil-mc cursors.

\(fn)" t nil)
 (autoload '+evil/mc-make-cursor-here "/Users/Richard/.emacs.d/modules/feature/evil/autoload/evil-mc" nil t)
 (autoload '+evil:mc "~/.emacs.d/modules/feature/evil/autoload/evil-mc" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/evil/autoload/advice"
;;;;;;  "modules/feature/evil/autoload/advice.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/evil/autoload/advice.el

(autoload '+evil*insert-newline-below-and-respect-comments "/Users/Richard/.emacs.d/modules/feature/evil/autoload/advice" "\
...
\(fn FILE-NAME)" nil nil)
 (autoload '+evil*window-split "/Users/Richard/.emacs.d/modules/feature/evil/autoload/advice" nil t)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/file-templates/autoload"
;;;;;;  "modules/feature/file-templates/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/file-templates/autoload.el

(def-setting! :file-template (pred &rest plist) :obsolete set-file-template! `(set-file-template! ,pred ,@plist))

(def-setting! :file-templates (&rest templates) :obsolete set-file-templates! `(set-file-templates! ,@templates))

(autoload '+file-templates--expand "/Users/Richard/.emacs.d/modules/feature/file-templates/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/lookup"
;;;;;;  "modules/feature/lookup/autoload/lookup.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/lookup/autoload/lookup.el

(def-setting! :lookup (modes &rest plist) :obsolete set-lookup-handlers! `(set-lookup-handlers! ,modes ,@plist))

(autoload '+lookup/definition "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/lookup" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/evil"
;;;;;;  "modules/feature/lookup/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/lookup/autoload/evil.el
 (autoload '+lookup:online "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/evil" nil t)
 (autoload '+lookup:dash "~/.emacs.d/modules/feature/lookup/autoload/evil" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/docsets"
;;;;;;  "modules/feature/lookup/autoload/docsets.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/lookup/autoload/docsets.el

(def-setting! :docset (modes &rest docsets) :obsolete set-docset! `(set-docsets! ,modes ,@docsets))

(autoload '+lookup-docsets-for-buffer "/Users/Richard/.emacs.d/modules/feature/lookup/autoload/docsets" "\
...
(autoload 'helm-dash-installed-docsets "/Users/Richard/.emacs.d/.local/packages/elpa/helm-dash-20180503.918/helm-dash")

(autoload 'helm-dash-docset-installed-p "~/.emacs.d/.local/packages/elpa/helm-dash-20180503.918/helm-dash")
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/snippets/autoload/snippets"
...
(autoload '+snippets-prompt-private "/Users/Richard/.emacs.d/modules/feature/snippets/autoload/snippets" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/snippets/autoload/settings"
;;;;;;  "modules/feature/snippets/autoload/settings.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/snippets/autoload/settings.el

(def-setting! :yas-minor-mode (mode) :obsolete set-yas-minor-mode! `(set-yas-minor-mode! ,mode))

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/snippets/autoload/evil"
;;;;;;  "modules/feature/snippets/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/snippets/autoload/evil.el

(autoload '+snippets/expand-on-region "/Users/Richard/.emacs.d/modules/feature/snippets/autoload/evil" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/syntax-checker/autoload"
;;;;;;  "modules/feature/syntax-checker/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/syntax-checker/autoload.el

(autoload '+syntax-checker-popup-mode "/Users/Richard/.emacs.d/modules/feature/syntax-checker/autoload" "\
TODO
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/workspaces/autoload/workspaces"
...
(autoload '+workspace-exists-p "/Users/Richard/.emacs.d/modules/feature/workspaces/autoload/workspaces" "\
...
(autoload '+workspace-load-session "~/.emacs.d/modules/feature/workspaces/autoload/workspaces" "\
...
(autoload '+workspace-save-session "~/.emacs.d/modules/feature/workspaces/autoload/workspaces" "\
...
(autoload '+workspace/load-last-session "~/.emacs.d/modules/feature/workspaces/autoload/workspaces" "\
...
(autoload '+workspace/restart-emacs-then-restore "~/.emacs.d/modules/feature/workspaces/autoload/workspaces" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/feature/workspaces/autoload/evil"
;;;;;;  "modules/feature/workspaces/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/feature/workspaces/autoload/evil.el
 (autoload '+workspace:save-session "/Users/Richard/.emacs.d/modules/feature/workspaces/autoload/evil" nil t)
 (autoload '+workspace:load-session "~/.emacs.d/modules/feature/workspaces/autoload/evil" nil t)
 (autoload '+workspace:save "~/.emacs.d/modules/feature/workspaces/autoload/evil" nil t)
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/emacs-lisp/autoload"
;;;;;;  "modules/lang/emacs-lisp/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/emacs-lisp/autoload.el

(autoload '+emacs-lisp-eval "/Users/Richard/.emacs.d/modules/lang/emacs-lisp/autoload" "\
...
(autoload '+emacs-lisp/repl "~/.emacs.d/modules/lang/emacs-lisp/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/javascript/autoload"
;;;;;;  "modules/lang/javascript/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/javascript/autoload.el

(autoload '+javascript-npm-conf "/Users/Richard/.emacs.d/modules/lang/javascript/autoload" "\
...
(autoload '+javascript/repl "~/.emacs.d/modules/lang/javascript/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/markdown/autoload"
;;;;;;  "modules/lang/markdown/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/markdown/autoload.el

(autoload '+markdown/insert-del "/Users/Richard/.emacs.d/modules/lang/markdown/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/tables"
;;;;;;  "modules/lang/org/autoload/tables.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/org/autoload/tables.el

(autoload '+org/table-next-row "/Users/Richard/.emacs.d/modules/lang/org/autoload/tables" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/org"
;;;;;;  "modules/lang/org/autoload/org.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/org/autoload/org.el

(autoload '+org-get-property "/Users/Richard/.emacs.d/modules/lang/org/autoload/org" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-present"
;;;;;;  "modules/lang/org/autoload/org-present.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/org/autoload/org-present.el

(autoload '+org-present/start "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-present" "\
TODO
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-link"
;;;;;;  "modules/lang/org/autoload/org-link.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/org/autoload/org-link.el

(autoload '+org-link-read-file "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-link" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-capture"
...
(autoload '+org-capture|cleanup-frame "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-capture" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-attach"
;;;;;;  "modules/lang/org/autoload/org-attach.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/org/autoload/org-attach.el

(autoload '+org-attach/sync "/Users/Richard/.emacs.d/modules/lang/org/autoload/org-attach" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/sh/autoload"
;;;;;;  "modules/lang/sh/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/sh/autoload.el

(autoload '+sh--match-variables-in-quotes "/Users/Richard/.emacs.d/modules/lang/sh/autoload" "\
...
(autoload '+sh/repl "~/.emacs.d/modules/lang/sh/autoload" "\
Open a shell REPL.
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/web/autoload/html"
;;;;;;  "modules/lang/web/autoload/html.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/web/autoload/html.el

(autoload '+web-encode-entities "/Users/Richard/.emacs.d/modules/lang/web/autoload/html" "\
TODO
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/web/autoload/evil"
;;;;;;  "modules/lang/web/autoload/evil.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/web/autoload/evil.el
 (autoload '+web:encode-html-entities "/Users/Richard/.emacs.d/modules/lang/web/autoload/evil" nil t)
 (autoload '+web:decode-html-entities "~/.emacs.d/modules/lang/web/autoload/evil" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/lang/web/autoload/css"
;;;;;;  "modules/lang/web/autoload/css.el" (0 0 0 0))
;;; Generated autoloads from modules/lang/web/autoload/css.el

(autoload '+css/toggle-inline-or-block "/Users/Richard/.emacs.d/modules/lang/web/autoload/css" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/tools/macos/autoload"
;;;;;;  "modules/tools/macos/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/tools/macos/autoload.el

(autoload '+macos-open-with "/Users/Richard/.emacs.d/modules/tools/macos/autoload" "\
Send PATH to APP-NAME on OSX.

\(fn &optional APP-NAME PATH)" t nil)

(autoload '+macos!open-with "~/.emacs.d/modules/tools/macos/autoload" "\


\(fn ID &optional APP DIR)" nil t)
 (autoload '+macos/open-in-default-program "/Users/Richard/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/reveal-in-finder "~/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/reveal-project-in-finder "~/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/send-to-transmit "~/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/send-cwd-to-transmit "~/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/send-to-launchbar "~/.emacs.d/modules/tools/macos/autoload" nil t)
 (autoload '+macos/send-project-to-launchbar "~/.emacs.d/modules/tools/macos/autoload" nil t)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/tools/magit/autoload"
;;;;;;  "modules/tools/magit/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/tools/magit/autoload.el

(autoload '+magit-display-buffer "/Users/Richard/.emacs.d/modules/tools/magit/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/doom-dashboard/autoload"
;;;;;;  "modules/ui/doom-dashboard/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/doom-dashboard/autoload.el

(autoload '+doom-dashboard/open "/Users/Richard/.emacs.d/modules/ui/doom-dashboard/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/doom-modeline/autoload"
;;;;;;  "modules/ui/doom-modeline/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/doom-modeline/autoload.el

(autoload '+doom-modeline|resize-for-big-font "/Users/Richard/.emacs.d/modules/ui/doom-modeline/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/hl-todo/autoload"
;;;;;;  "modules/ui/hl-todo/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/hl-todo/autoload.el

(autoload '+hl-todo|use-face-detection "/Users/Richard/.emacs.d/modules/ui/hl-todo/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/nav-flash/autoload"
;;;;;;  "modules/ui/nav-flash/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/nav-flash/autoload.el

(autoload '+nav-flash-blink-cursor "/Users/Richard/.emacs.d/modules/ui/nav-flash/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/popup/autoload/settings"
...
(autoload '+popup--make "/Users/Richard/.emacs.d/modules/ui/popup/autoload/settings" "\


\(fn PREDICATE PLIST)" nil nil)

(def-setting! :popup (condition &optional alist parameters) :obsolete set-popup-rule! `(set-popup-rule! ,condition ,alist ,parameters))

(def-setting! :popups (&rest rulesets) :obsolete set-popup-rules! `(set-popup-rules! ,@rulesets))

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/popup/autoload/popup"
;;;;;;  "modules/ui/popup/autoload/popup.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/popup/autoload/popup.el

(autoload '+popup--init "/Users/Richard/.emacs.d/modules/ui/popup/autoload/popup" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/treemacs/autoload"
;;;;;;  "modules/ui/treemacs/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/treemacs/autoload.el

(autoload '+treemacs/toggle "/Users/Richard/.emacs.d/modules/ui/treemacs/autoload" "\
...
;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/vc-gutter/autoload"
;;;;;;  "modules/ui/vc-gutter/autoload.el" (0 0 0 0))
;;; Generated autoloads from modules/ui/vc-gutter/autoload.el
 (autoload '+vc-gutter-hydra/body "/Users/Richard/.emacs.d/modules/ui/vc-gutter/autoload" nil nil)

;;;***

;;;### (autoloads nil "/Users/Richard/.emacs.d/modules/ui/vi-tilde-fringe/autoload"
...
(progn (autoload (quote set-electric!) "~/.emacs.d/modules/emacs/electric/autoload" "Declare :words (list of strings) or :chars (lists of chars) in MODES that
trigger electric indentation.

(fn MODES &rest PLIST)" nil nil) (function-put (quote set-electric!) (quote lisp-indent-function) (quote defun)))
(put (quote set-electric!) (quote doom-module) (quote (:emacs . electric)))
(autoload (quote set-eshell-alias!) "~/.emacs.d/modules/emacs/eshell/autoload/settings" "Define aliases for eshell.

(fn &rest ALIASES)" nil nil)
...
(fn PRED &rest PLIST)" nil nil) (function-put (quote set-file-template!) (quote lisp-indent-function) (quote defun)))
(put (quote set-file-template!) (quote doom-module) (quote (:feature . file-templates)))
(autoload (quote set-file-templates!) "~/.emacs.d/modules/feature/file-templates/autoload" "Like `set-file-templates!', but register many file templates at once.

(fn &rest TEMPLATES)" nil nil)
...
(fn MODES &rest PLIST)" nil nil) (function-put (quote set-lookup-handlers!) (quote lisp-indent-function) (quote defun)))
...
(put (quote set-docset!) (quote doom-file) "~/.emacs.d/modules/feature/lookup/autoload/docsets.el")
(put (quote set-docset!) (quote doom-module) (quote (:feature . lookup)))
(defalias (quote set-docset!) (function set-docsets!) nil)
...
(put (quote def-modeline-format!) (quote doom-file) "~/.emacs.d/modules/ui/modeline/autoload/settings.el")
(defmacro def-modeline-format! (name left &optional right) "THIS FUNCTION DOES NOTHING BECAUSE (:ui . modeline) IS DISABLED
...
keep them left and right aligned respectively." (ignore name left right))
(put (quote def-modeline-format!) (quote doom-module) (quote (:ui . modeline)))
(put (quote def-modeline-segment!) (quote doom-file) "~/.emacs.d/modules/ui/modeline/autoload/settings.el")
(defmacro def-modeline-segment! (name &rest rest) "THIS FUNCTION DOES NOTHING BECAUSE (:ui . modeline) IS DISABLED

TODO" (ignore name rest))
(put (quote def-modeline-segment!) (quote doom-module) (quote (:ui . modeline)))
(put (quote set-modeline!) (quote doom-file) "~/.emacs.d/modules/ui/modeline/autoload/settings.el")
(defmacro set-modeline! (name &optional default) "THIS FUNCTION DOES NOTHING BECAUSE (:ui . modeline) IS DISABLED

Replace the current buffer's modeline with a preset mode-line format defined
with `def-modeline-format!'.

If DEFAULT is non-nil, make it the default mode-line for all buffers." (ignore name default))
...
(fn PREDICATE &rest PLIST)" nil nil) (function-put (quote set-popup-rule!) (quote lisp-indent-function) (quote defun)))
...
(defmacro set-pretty-symbols! (modes &rest rest) "THIS FUNCTION DOES NOTHING BECAUSE (:ui . pretty-code) IS DISABLED
...
Pretty symbols can be unset for emacs-lisp-mode with:
  ...
  (set-pretty-symbols! 'emacs-lisp-mode nil)" (ignore modes rest))
